...
error_reporting(E_ALL ^ E_NOTICE);
    ...
    $ssql= "SELECT rc.*, b.nombre,ct.alias
            FROM `r_cuentas` as rc 
            JOIN banco as b ON banco_id=b.id
            JOIN r_cuenta_tipo as ct ON rc.tipo_cta_id=ct.id";
...
<body>
    ...
    <div class="wrapper">
            <nav class="navbar navbar-dark bg-dark" id="navbar">
                <div class="container-fluid" id="tabletitle">
                    <a class="navbar-brand">Reempadronamiento de Ctas.</a>
                </div>
            </nav>
                ...
                <table class="table table-secondary" id="mydatatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th><a href="indexctas.php?sec=cuentas_cta/verdatos&id=<?php echo $fila['id'];?>"
                                    class="thickbox" title="Ver datos"><button class="bn12"><i
                                            class="fas fa-search"></i></button></a></th> 
                            <th><a href="indexctas.php?sec=cuentas_cta/editardatos&id=<?php echo $fila['id'];?>"
                                    class="thickbox" title="Verificar cuenta"><button class="bn13"><i
                                            class="fas fa-check-square"></i></button></a></th>               
                            <th><a href="" class="thickbox" title="Ver archivos"><button class="bn14"><i
