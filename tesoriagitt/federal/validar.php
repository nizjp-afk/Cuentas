	...
	if (isset($_POST['validar']))
	   {
		...
		if ($bandera==1)
	  		{
			 header('location: ../indextesoreria.php?sec=federal/error&valor='.$tipo.'&ban=1');
			}
		elseif ($cant >0)
		    {
			 header('location: ../indextesoreria.php?sec=federal/error&valor='.$tipo.'&ban=2');
			}
					...
					if($validez==0)
					  {
		     	      ...
		     	      if ($tipo=='f')
					    {
?>						  
						  <meta http-equiv='refresh' content='0;url=                       ../indextesoreria.php?sec=federal/f_alta&c1=<?php echo $cuitl_1; ?>&c2=<?php echo $cuitl_2; ?>&c3=<?php echo $cuitl_3; ?>'	 />	               
<?php						  
				         }
			           else
			               {
?>						  
						  <meta http-equiv='refresh' content='0;url=                       ../indextesoreria.php?sec=federal/j_alta&c1=<?php echo $cuitl_1; ?>&c2=<?php echo $cuitl_2; ?>&c3=<?php echo $cuitl_3; ?>'	 />	               
<?php					
				           }
					  }
					else
					   {
?>
<meta http-equiv='refresh' content='0;url=../indextesoreria.php?sec=beneficiario/error&valor=<?php echo $tipo; ?>&ban=3' />	
<?php
				       }  	  
			}		
	}		
