...
AND aplicaciones_cod = 'tgpc'";
  ...
  $sociedad_tipo = trim($f_beneficiario['sociedad_tipo']);
   $sociedad_tipo_n = trim($f_beneficiario['sociedad_tipo']);
   $ingreso_bruto = $f_beneficiario['ingreso_bruto'];
   $iva_situacion = $f_beneficiario['iva_situacion'];
...
<form action="" method="post">
  <table border="0" align="center">
    ...
    <tr>
      ...
      <td width="549"><?php echo $cuitl; ?></td>
    </tr>
    <tr height=10px>
      <td colspan="2"><hr /></td>
    </tr>
    ...
    <tr>
      ...
      <td><?php echo $direccion_f_calle; ?> </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><?php  echo $direccion_f_provincia; ?>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="subtitle">Provincia</td>
      <td><?php echo $direccion_r_provincia; ?> </td>
    </tr>
    <tr>
      <td class="subtitle">Localidad</td>
      <td><?php echo $direccion_r_localidad; ?> </td>
    </tr>
    <tr>
      <td class="subtitle">Codigo Postal</td>
    ...
    <tr>
      ...
      <td><?php echo $fechac_s; ?> </td>
    </tr>
    <tr>
      <td class="subtitle">Tipo de Sociedad</td>
      <td><?php echo $sociedad_tipo; ?> </td>
    </tr>
...
?> </td>
   ...
   <td><?php echo $banco_denominacion; ?></td>
    ...
    <tr>
      <td align="center" colspan="2"><a href="indextesoreria.php?sec=federal/modificar_j&apli=orden&per=F&id=<?php echo $id;?>&tipo=<?php echo $tipo; ?>">Modificar</a></td>
    </tr>
  </table>
</form> 
</div>
