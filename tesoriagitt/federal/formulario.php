...
$pdf->setY(10);
$pdf->Image('../img/escudo.jpg',20,8,8);
//$pdf->SetX(105);
...
$pdf->setY(25);
$pdf->cell(0,0,'FORMULARIO DE ALTA Y MODIFICACION DE DATOS DE BENEFICIARIOS EN EL SISTEMA PROVINCIAL DE ADMINISTRACION FINANCIERA',0,'B','C',0);
...
$pdf->SetY($i);
$pdf->SetX(15);
$pdf->Cell(8,5,'CUIT /CUIL: ',0,0,'L',1);
$pdf->SetY($i);
$pdf->SetX(30);
$pdf->Cell(20,5,'27245138615',0,0,'L',1);
$pdf->SetY($i=$i+7);
$pdf->SetX(15);
$pdf->Cell(0,5,'DATOS DE IDENTIFICACION',1,0,'L',1);
$pdf->SetY($i=$i+7);
$pdf->SetX(25);
$pdf->Cell(0,7,'Denominacion de la Entidad:',0,0,'L',1);
$pdf->SetY($i);
$pdf->SetX(60);
$pdf->Cell(0,7,'nombre der la razon social',0,0,'L',1);
$pdf->SetY($i=$i+7);
$pdf->SetX(15);
