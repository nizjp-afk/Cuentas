...
//   $ingresobruto=split("-",$ingreso_bruto);
   ...
   // $alicuota = $_POST['alicuota'];
	...
	$cuit1_u = $_POST['cuit_u1'];
    $cuit2_u = $_POST['cuit_u2'];
    $cuit3_u = $_POST['cuit_u3'];
    $cuit4_u = $_POST['cuit_u4'];
	$cuit5_u = $_POST['cuit_u5'];
    $cuit6_u = $_POST['cuit_u6']; 
	
	
	$razon1_u = $_POST['razon_social_u1'];
    $razon2_u = $_POST['razon_social_u2'];
    $razon3_u = $_POST['razon_social_u3'];
    $razon4_u = $_POST['razon_social_u4'];
	$razon5_u = $_POST['razon_social_u5'];
    $razon6_u = $_POST['razon_social_u6']; 
	
	$dom1_u = $_POST['direccion_u1'];
    $dom2_u = $_POST['direccion_u2'];
    $dom3_u = $_POST['direccion_u3'];
    $dom4_u = $_POST['direccion_u4'];
	$dom5_u = $_POST['direccion_u5'];
    $dom6_u = $_POST['direccion_u6'];
...
<div class="content">
<form action="indextesoreria.php?sec=federal/validardatos_j" method="post">	
	<table border="0" align="center">
		
		<tr>
			<td colspan="2"><h1>Alta Persona Juridica</h1></td>
		</tr>
		...
		<tr>
			<td width="239" class="subtitle">Nro. CUIL | CUIT</td>
		<td width="549">
...
<?php
       ...
       <tr bgcolor="#EAEAEA">
			<td colspan="2"><div id="div_ute" style="display:none"><h4>&nbsp;Empresas que Integran la U.T.E </h4></div></td>
		</tr>
		<tr height="2px">
			<td colspan="2"><div id="div_ute1" style="display:none">&nbsp;</div></td>
		</tr>
		<tr>
		    <td colspan="2"><div id="div_ute2" style="display:none">
			    <table>
				     <tr bgcolor="#EAEAEA">
