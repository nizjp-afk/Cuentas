...
error_reporting ( E_ERROR );
  ...
  $nombre_f = ucwords(strtolower($_POST['fantasia']));   
...
//ingreso_bruto_ac
/*	$patron = "[[:digit:]]{9,10}";
	if (!(ereg($patron, $ingreso_bruto_ac)))
		{
		    $bandera =1; 
			$bandera_ingreso_bruto_ac=1;
    	}			
	*/				
//cbu
    $patron = "[[:digit:]]{22}";
...
if ($bandera == 1) 
	   {
?>	   
      <form action="indextesoreria.php?sec=federal/f_alta" method="post">
<?php
	   }
	 else
	   {
?>	     
<form action="indextesoreria.php?sec=federal/registro_f" method="post">
<?php 
        }
...
<table border="0" align="center">
	<tr>
		<td colspan="2"><h1>Validacion Alta Persona Fisica</h1></td>
	</tr>
	<tr height=10px>
		<td colspan="2"><hr></td>
	</tr>
