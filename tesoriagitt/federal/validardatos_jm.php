...
<?php
     if ($bandera ==1)
	   {
?>	   
       <form action="indextesoreria.php?sec=federal/modificar_j&apli=<?php echo $apli; ?>&per=<?php echo $per; ?>" method="post">
<?php
	   }
	 else
	   {
?>	     
<form action="indextesoreria.php?sec=federal/update_j" method="post">
<?php 
        }
?>	
