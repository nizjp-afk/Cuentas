...
<?php 
  if ($vdir=='D')
    {
?>
   <FORM name="sampleform" action="indextesoreria.php?sec=ordenes/carga_orden_pagadas_dir&apli=orden&per=C" method="POST" >
<?php
	}
 elseif($nrosaf=='N')
    {
...
<FORM name="sampleform" target="_blank" action="ordenes/listado_ordenes.php?apli=orden&per=C" method="POST" >
<input type="hidden" name="cuit" value="<?php echo $usuario;?>">
<?php
	}
else
   {
...
<FORM name="sampleform" action="indextesoreria.php?sec=ordenes/carga_orden_pagadas&apli=orden&per=C" method="POST" >
