...
//conexion
    ...
    $permisosnecesarios = $_GET['per'];
	 ...
	 $accion='Consulta Ordenes Pagadas';
	 $tabla='orden_pago';
...
FROM orden_pago, nro_saf
			                  WHERE (orden_pago.saf='$nrosaf' or orden_pago.cuit='$usuario') and orden_pago.saf = numero
							  AND (orden_pago ='$nom' or orden_pago.cuit ='$nom')
...
<tr>
        ...
        <td height="30" colspan="2" ><a title="Listado de Orden de Pago" href="ordenes/listado_ordenes_saf.php?fechah=<?php echo $fechahoy; ?>&fehcaa=<?php echo $fechaant; ?>&dato=<?php echo $usuario; ?>&saf=<?php echo $nrosaf; ?>&cuit=<?php echo $nom; ?>" target="_blank"  ><img src="img/print_odp.jpg" width="35" align="" height="24" border="0"/></a>   
		</td>     
    </tr>
</table>    
...
?>	   
	     <tr bgcolor="#F3F3F3"  class="fuframe1" > 
		  ...
		  <?php echo $f_orden['saf'];?></a> </td>
            ...
            <td width="136" align="left"><?php echo $f_bene['apellido'].' '.$f_bene['nombre']; echo substr($f_bene['razon_social'],0,20);?></font></td>
