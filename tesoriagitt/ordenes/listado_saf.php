<?php
   ...
   include('../dgti-mysql-var_dgti-beneficiarios.php');
    ...
    //include('conexion/extras.php');
	 ...
	 $_pagi_sql = "SELECT  * FROM nro_saf ORDER BY `nro_saf`.`numero` ASC";
...
$pdf->setY(45);
$pdf->cell(0,0,'LISTADO DE SAF',0,'B','C',0);
...
$pdf->SetY($y_axis_initial);
$pdf->SetX(15);
$pdf->Cell(30,7,'NUMERO DE SAF',1,0,'C',1);
$pdf->Cell(100,7,'CONCEPTO',1,0,'C',1);
...
while($f_ordenes= mysql_fetch_array ($ordenes))
{
       ...
       $saf=$f_ordenes['numero'];
      
	   $concepto=$f_ordenes['nombre'];
	...
	$pdf->SetX(15);
	$cont=$cont+1;
    $pdf->Cell(30,6,$saf,1,0,'L',1);
	$pdf->Cell(100,6,$concepto,1,0,'L',1);
