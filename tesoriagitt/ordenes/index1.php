...
?>		
    <li><a href="indextesoreria.php?sec=contaduria/contra&apli=orden&per=C" >Cambiar Contrase&ntilde;a</a></li>
     <li><a href="indextesoreria.php?sec=ordenes/periodo&apli=orden&per=C">Ordenes Pagadas </a> </li>
	      
    <li><a target="_blank" href="pendientes/listado_ordenes_pendientes_benef.php?apli=orden&per=C&cuit=<?php  echo $usuario;?> ">Ordenes Pendientes de Pago </a> </li>   <?php
	 }
	 ?>
