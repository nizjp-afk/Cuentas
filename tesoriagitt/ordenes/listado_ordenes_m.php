...
/*	include('dgti-mysql-var_dgti-beneficiarios.php');
 ...
 $_pagi_sql = "SELECT `nro_saf`. * , `orden_pago`. * 
   ...
   ////////////////////////////
		 ...
		 $_pagi_sql = "SELECT o.fecha, s.ESCRITURAL, o.orden_pago, o.concepto, o.total, o.ejercicio, b.nombre, b.apellido, b.razon_social
...
while($f_ordenes= mysql_fetch_array ($ordenes))
{
			...
			$pdf->SetFont('Arial','IB',7);
			$pdf->setY(40);
			$pdf->cell(0,0,'LISTADO DE ORDENES DE PAGO DE FONDO DE TESORO',0,'B','C',0);
