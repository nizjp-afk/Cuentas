<?php
   ...
   ////////////////////////////
		 ...
		 $_pagi_sql = "SELECT * FROM op_pendientes_r where cuit='$cuit'  and Ejercicio > '2010' and estado='N'";
	 ...
	 $_pagi_sql = "SELECT * FROM op_pendientes_fp_r where cuit='$cuit'  and Ejercicio > '2010' and estado='N'";
