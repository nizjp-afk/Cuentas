...
<body>
<div class="content">
    <FORM name="sampleform" action="hacienda/listado_ordenes_pagadas_uci.php?apli=h&per=C" method="POST" target="_blank" >
...
<OPTION value="<? echo $f_saf['numero'] ?>"> <? echo $f_saf['numero'].' - '.$f_saf['nombre']?></OPTION>
        ...
        <tr>
          ...
          <td width="8%" colspan="2" align="center">
              <input type="image" src="img/xls.jpg" height="32"  width="32"   name="aceptar" value="Agregar" title="Descargar Datos"  />          </td>
        </tr>
  </table>
</form>
<br> 
