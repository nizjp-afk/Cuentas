...
<div class="content">
<h1>Modificacion de Cuenta Bancaria</h1>
...
if($estado=='A')
  {		
?>
		        <td>&nbsp;<a href="indextesoreria.php?sec=contaduria/formulariocta&id=<?php echo $f_persona['id_beneficiario'];?>&tipo=<?php echo $f_persona['persona_tipo']; ?>&apli=tgpa&per=M"><img src="img/b_edit.png" width="16" height="16" border="0"/></a>&nbsp;</td>
<?php
  }
else
  {
...
<ul>
	<li><a href="indextesoreria.php?sec=tesoreria/beneficiarios_aprobado_modi&tipo=f&apli=tgp&per=C">Beneficiario Persona Fisica</a></li>
    <li><a href="indextesoreria.php?sec=tesoreria/beneficiarios_aprobado_modi&tipo=j&apli=tgp&per=C">Beneficiario Persona Juridica</a></li>

	<li><a href="indextesoreria.php?sec=tesoreria/beneficiarios_aprobado_modi&tipo=o&apli=tgp&per=C">Beneficiarios Otras Personas</a></li>
