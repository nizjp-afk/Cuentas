...
error_reporting ( E_ERROR ); 
 $aplicacion = $_GET['apli'];
  ...
  include('incluir_siempre.php');
	...
	{
		$nom = $_POST['busnom'];
		$_pagi_sql =	"SELECT cuitl,apellido,nombre,razon_social,persona_tipo,id_beneficiario FROM beneficiarios 
	    				WHERE cuitl='$nom' or apellido like '%$nom%' or  razon_social like '%$nom%' and persona_tipo ='o''";
	}
	else 
	{
    	$_pagi_sql = "SELECT cuitl,apellido,nombre,razon_social,persona_tipo,id_beneficiario FROM beneficiarios where persona_tipo ='o'
...
?>
        ...
        <td>&nbsp;<a href="indextesoreria.php?sec=tesoreria/nuevo_saf&id=<?php echo $f_persona['cuitl'];?>&tipo=<?php echo $f_persona['persona_tipo']; ?>"><img src="img/hc.png" border="0"/></a>&nbsp;</td>
