...
//fecha inicio de designacion

    $patron = "(([0-9]{4})-[0-9]{2})-([0-9]{2})";
	if (!(ereg($patron, $fecha_inicio1)) )
    	{
		   
		    $bandera=1;
			$bandera_fecha_inicio1 = 1;
        }
	
  if (!($fecha_inicio2=='-----------'))	
	   {
	if (!(ereg($patron,$fecha_inicio2)) )
    	{
		    $bandera_fecha_inicio2 = 1;
        }
	   }
	   
 if (!($fecha_inicio3=='-----------'))	
	   {	   	
	if (!(ereg($patron, $fecha_inicio3)) )
    	{

			$bandera_fecha_inicio3 = 1;
        }
	  }
	 
if (!($fecha_inicio4=='-----------'))	
	   {	  			
   if (!(ereg($patron,$fecha_inicio4)) )
    	{
		    $bandera_fecha_inicio4 = 1;
        }
       }
...
<?php
     if ($bandera ==1)
	   {
?>	   
       <form action="indextesoreria.php?sec=tesoreria/modificar_j&apli=<?php echo $apli; ?>&per=<?php echo $per; ?>" method="post">
<?php
	   }
	 else
	   {
?>	     
<form action="indextesoreria.php?sec=tesoreria/update_j" method="post">
<?php 
        }
?>	
