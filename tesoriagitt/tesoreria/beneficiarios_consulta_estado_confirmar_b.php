...
<div class="content">
<form action="tesoreria/imprimir_nota_b.php?apli=tgpc&per=A" method="post"  target="_blank">
...
?>
        ...
        <td><a target="_parent" href="indextesoreria.php?sec=tesoreria/desconfirmar_estado_b&apli=tgpc&per=A&id=<?php echo $f_persona['id_beneficiario']; ?>"><img src="img/iconos_D.png" border="0" height="16" width="16"/></a></td>
...
<div class="sidenav">
 ...
 <li><a href="indextesoreria.php?sec=tesoreria/beneficiarios_consulta_estado_b&apli=tgpai&per=A">Regresar Menu</a></li>
</div>
<div class="sidenav">
</div>
