...
<?php
  if($vdir=='DE')
   {
	   ?>
    <FORM name="sampleform" action="hacienda/listado_ordenes_pagadas.php?apli=h&per=C" method="POST" target="_blank" >
   ...
   {
	   ?>
  <FORM name="sampleform" action="tesoreria/listado_ordenes_dir.php?apli=orden&per=C" method="POST" target="_blank" >
   <?php
   }
   ?>
