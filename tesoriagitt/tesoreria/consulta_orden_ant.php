...
<tr>
       ...
       <input name="ejer" type="submit" class="Boton" id="ejer" title="Ordenadas por Ejercicios de generacion de O.P" value="Ejercicio Anteriores" />
        ...
        <?php if($nrosaf=='T' or $nrosaf=='C' )
{
	?>

       <a title="Imprimir Consulta" href="pendientes/listado_ordenes_pendientes_ftt.php?consul=<?php echo $y ?>&nom=<?php echo $nom; ?>&ban=<?php echo $b_eje; ?>" target="_blank"  ><img src="img/pdf.png" width="35" align="" height="24" border="0"/></a> 
	<?php
}
else
{
...
THEN 'B'
WHEN 'I'
THEN 'I' END AS estado, op_pendientes. *  FROM op_pendientes 
				              where (Numero_OP='$nom' or cuit ='$nom' or concepto like '%$nom%')
							   and Ejercicio <'$y'
