...
<?php	
    ...
    for ($var=0;$var<$cuantos;$var++)
	{
	   ...
	   $ssql = "SELECT * FROM `beneficiarios_aprobados` WHERE cbu='$cbu' ";
     if (!($r_beneficiario= mysql_query($ssql, $conexion_mysql)))
    {
	 ...
	 $f_beneficiario= mysql_fetch_array ($r_beneficiario);					
		...
		if($cant>0)
		{
		 ...
		 echo $ssql = "UPDATE beneficiarios_aprobados SET inhi='$inhi', motivo='$motivo' WHERE cbu='$cbu'";
				 if (!($r_beneficiarios = mysql_query($ssql,$conexion_mysql)))
				 {
					  //.....................................................................
					  // informa del error producido
					  $cuerpo1  = "al intentar modificacion un beneficiario";
					  echo $cuerpo1;
						   exit;
					  //.....................................................................
				 }
         ...
         $cbub=$f_beneficiario['cbu'];
		  ...
		  $codigo_esidif=$f_beneficiario['codigo_esidif'];
   ...
   <table width="70%" height="89" border="1" >
    ...
    <td colspan="3"><h3>Cuentas Inhabilitadas por el Banco </h3></td>
      ...
      <tr>
        ...
        <td align="center" width="42">TIPO</td>
        <td align="center" width="42">NR SIDIF</td>
      ...
      <tr>
        ...
        <td><?php echo $cbub; ?>
        <td><?php echo $persona_tipo; ?>
        <td><?php echo $codigo_esidif; ?>
