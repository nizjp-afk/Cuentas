 ...
 if (isset($_POST['busca']) and !empty($_POST['busnom']))
	{
		...
		id_beneficiario,fecha_aprobacion,saf FROM beneficiarios 
	    				WHERE cuitl='$nom' or apellido like '%$nom%' or nombre_f like '%$nom%' or  razon_social like '%$nom%' or  nombre_f like '%$nom%' and alta <> 'S' ";
	}
...
?>	        
		...
		<td>&nbsp;<a href="indextesoreria.php?sec=tesoreria/formulariomodi&apli=tgp&per=O&id=<?php echo $f_persona['id_beneficiario'];?>&tipo=<?php echo $f_persona['persona_tipo']; ?>&id_saf=<?php echo $f_saf['id_saf']; ?>"><img src="img/b_edit.png" width="16" height="16" border="0"/></a>&nbsp;</td>
