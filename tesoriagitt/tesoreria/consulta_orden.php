...
{
	    $accion='Consulta Ordenes Pagadas y Pendiente de FP y FT';
...
<tr>
        ...
        <a title="Listado de Orden de Pago" href="pendientes/listado_ordenes_pendientes_fpn.php?consul=<?php echo $y ?>&nom=<?php echo $nom; ?>&ban=<?php echo $b_eje; ?>" target="_blank"  ><img src="img/pdf.png" width="35" align="" height="24" border="0"/></a> 
         <a title="Imprimir Consulta" href="tesoreria/listado_ordenes_xls.php?consul=<?php echo $y ?>&nom=<?php echo $nom; ?>&ban=<?php echo $b_eje; ?>" target="_blank"  ><img src="img/xls.jpg"  width="35" align="" height="24" border="0"/></a>     
		<?php } ?></td>   
...
if (isset($_POST['busca']) and !empty($_POST['busnom']))
			{
			 ...
			 $_pagi_sql = "SELECT orden_pago.*, (IMP_FORM - RETENCION - IMPORTE_A_PAGAR-IMP_DESAF ) AS pagado, (IMP_FORM - RETENCION  )as Imp_orden,escritural.ESCRITURAL  FROM orden_pago,escritural
				              where ((NUMERO='$op_n' and FORMULARIO='$op_f' AND orden_pago.SAF='$op_s') or CUIT ='$nom' or concepto like '%$nom%'  )
 ...
 //echo 'paso4';echo "<br>";
		 ...
		 $estado_op=$f_ordenp['ESTADO'];
		   ...
		   $IMP3=number_format($f_ordenp['IMPORTE_A_PAGAR'],2);
		    $Imp_orden=number_format($f_ordenp['Imp_orden']+$f_ordenp['IMP_DESAF'],2);
         ...
         include('dgti-intranet-mysql_select_db.php');
		  ...
		  $ssql = "SELECT * FROM beneficiarios_aprobados where cuitl='$d_cuit' ";
		   ...
		   if($razon_social_b=='')
	        ...
	        $f_g=explode("-", $f_ordenp['FECHA_INGRESO']); 
           $fecha_ing=$f_g[2].'-'.$f_g[1].'-'.$f_g[0]; 
		   
		  $dias	= (strtotime($fecha_ing)-strtotime($dia))/86400;
	       $dias 	= abs($dias);
		   $resultado_resta = floor($dias);
...
?>	
		  ...
		  <td  height="30" align="center"><?php echo $f_ordenp['FECHA_INGRESO'];?></td> 
         ...
         <td    title="<?php echo $obser; ?>" align="left"><?php echo substr($f_ordenp['CONCEPTO'],0,20);?></font></td>
           <td  align="right">&nbsp;<?php echo $IMP1;?></td>
     ...
     // echo 'paso7';echo "<br>";
         ...
         include('dgti-intranet-mysql_select_db.php');
		  ...
		  $ssql = "SELECT * FROM beneficiarios_aprobados where cuitl='$d_cuit' ";
		   ...
		   //$resultado_resta =abs( restaFechas($fecha_ing,$dia));
