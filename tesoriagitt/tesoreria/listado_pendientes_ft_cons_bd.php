...
if($nom!='')
      {
		 $_pagi_sql = "SELECT  *
FROM op_pendientes where (Saf='$nom' or Numero_OP='$nom' or cuit='$nom') AND estado='N' AND (Ejercicio >='$fecha_cons' and  Ejercicio  <= '$anterior') ORDER BY Numero_OP  ASC";
...
$pdf->setY(45);
$pdf->cell(0,0,'LISTADO DE ORDENES DE PAGO PENDIENTES  EJERCICIOS VENCIDOS ',0,'B','C',0);
...
$pdf->SetFont('Arial','I',8);
 //Print current and total page numbers
$pdf->Cell(0,10,'Pagina '.$pdf->PageNo().'/{nb}',0,0,'C');			//Add first page		//Add first page
		    $pdf->AddPage();
