...
//variables recibidas
 ...
 //datos de alta web 
	...
	$ssql = "UPDATE beneficiarios SET apellido='$apellido',nombre='$nombre',nombre_f='$nombre_f',
				  ...
				  fecha_s='$fechai_s',
					...
					verificador2='$cbucont6',cbu='$banco_cbu',
		...
		$ssql = "UPDATE saf SET banco_nombre='$banco_nombre',
		 ...
		 $accion='Modificacion Beneficiarios Fisico';
		  $tabla='beneficiarios';
...
<code>Haga click <a target="_blank" href='tesoreria/impresion.php?cuitl=<?php echo $cuitl;?>&tipo=<?php echo $persona_tipo; ?>'>aqu&iacute;</a> </code>
