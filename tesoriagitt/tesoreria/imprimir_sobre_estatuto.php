...
$pdf->SetFont('Arial','',20);
$pdf->Cell(0,6,'Domicilio:'.$domicilio.'',0,0,'L');				 
...
$pdf->SetFont('Arial','',20);
$pdf->Cell(0,6,$direccion_f_localidad.' - '.$direccion_f_provincia ,0,0,'L');				 
...
$pdf->SetFont('Arial','',20);
$pdf->Cell(0,6,'Codigo Postal:'.$codigo_f_postal,0,0,'L');				 

$pdf->SetY(-45);
$pdf->SetX(150);
$pdf->SetFont('Arial','I',8);
 //Print current and total page numbers
$pdf->Cell(0,6,'RTTE:',0,0,'L');
$pdf->SetY(-40);
$pdf->SetX(150);
$pdf->SetFont('Arial','I',8);
 //Print current and total page numbers
...
$pdf->SetFont('Arial','I',8);
 //Print current and total page numbers
$pdf->Cell(0,6,'REGISTRO DE BENEFICIARIOS',0,0,'L');
$pdf->SetY(-30);
$pdf->SetX(150);
$pdf->SetFont('Arial','I',8);
 //Print current and total page numbers
...
$pdf->SetFont('Arial','I',8);
 //Print current and total page numbers
$pdf->Cell(0,6,'CASA DE GOBIERNO',0,0,'L');
$pdf->SetY(-20);
$pdf->SetX(150);
$pdf->SetFont('Arial','I',8);
 //Print current and total page numbers
$pdf->Cell(0,6,'LA RIOJA -CAPITAL- C.P:5300',0,0,'L');
