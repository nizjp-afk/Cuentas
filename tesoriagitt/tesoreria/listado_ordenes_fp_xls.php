...
if($ej_a=='EA')
   {   
        $_pagi_sql1 = "SELECT  fecha AS FECHA, ESCRITURAL,ejercicio AS EJERCICIO, FUENTE,CLASE,orden_pago AS ORDEN, b.cuitl AS CUIT,  CONCAT( b.apellido, ' ', b.nombre, ' ', b.razon_social ) AS DENOMINACION, concepto AS CONCEPTO, total AS TOTAL,retencion as RETENCIONES
