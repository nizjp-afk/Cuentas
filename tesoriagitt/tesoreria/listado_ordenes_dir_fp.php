...
//	$fechahoy=$_GET['fechah'];
 ...
 if ($nom=='N' and $cuit_or=='')
    {
		 $_pagi_sql = "SELECT o.fecha,  o.orden_pago, o.concepto, o.total, o.ejercicio,o.cuit
				  		      FROM orden_pago_fp as o
...
if ($nom=='N' and $cuit_or!='')
    {
		 $_pagi_sql = "SELECT o.fecha, o.orden_pago, o.concepto, o.total, o.ejercicio, b.nombre, b.apellido, b.razon_social
