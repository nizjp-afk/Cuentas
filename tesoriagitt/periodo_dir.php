...
?>
<OPTION <?php if ($dato =='E'){?> value="<? echo $f_saf['ESCRITURAL'] ?>" <?php } else {?>value="<? echo $f_saf['ID'] ?>" <?php } ?> > <?php if($dato=='T'){?> <? echo $f_saf['SAF'].' '.$f_saf['DENOMINACION'];?> <?php } else { ?> <? echo $f_saf['ESCRITURAL'].' '.$f_saf['DENOMINACION'];?><?php } ?></OPTION>
