...
<tr>
        ...
        <td height="30" colspan="2" ><a title="Listado de Orden de Pago" href="tesoreria/listado_ordenes_dir.php?fechah=<?php echo $fechahoy; ?>&fehcaa=<?php echo $fechaant; ?>&nom=<?php echo $saf_c; ?>&cuit=<?php echo $nom; ?>" target="_blank"  ><img src="img/print_odp.jpg" width="35" align="" height="24" border="0"/></a>   
		</td>     
    </tr>
</table>    
