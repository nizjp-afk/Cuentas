 ...
 error_reporting ( E_ERROR );
   ...
   // include('conexion/extras.php');
	...
	
	{
		 if($estado_t=='C')
			     {
		$ssql = "delete from `op_pendiente_tmp` where `nro_ti` != '$nroaux'";
     if (!($r_cf= mysql_query($ssql, $conexion_mysql)))
    {
      //.....................................................................
      // informa del error producido
      ...
      //.....................................................................
		...
		$ssql = "UPDATE `op_pendiente_tmp` SET  nro_ti='1' where `nro_ti` = '$nroaux'";
     if (!($r_cf= mysql_query($ssql, $conexion_mysql)))
    {
      //.....................................................................
      // informa del error producido
	...
	$nro=2;
	 ...
	 $ssql = "UPDATE control_fecha SET c_fecha='$d_fecha' where id=1";
							 if (!($r_cf= mysql_query($ssql, $conexion_mysql)))
							{
							  //.....................................................................
							  // informa del error producido
	 ...
	 $ssql = "SELECT * FROM op_pendiente_tmp where nro_ti='$nroaux' order by Saf,Numero_OP ASC ";
   ...
   $cant = mysql_num_rows($r_op);
	...
	$ssql = "UPDATE `op_pendiente_tmp` SET  hora='$hora', tgp='C' where `nro_ti` = '$nroaux'";
     if (!($r_cf= mysql_query($ssql, $conexion_mysql)))
    {
      //.....................................................................
      // informa del error producido
...
mail("aurora.lobos@gmail.com,tgp.larioja@gmail.com,eduescudero@larioja.gov.ar,manuelfuentesoro@gmail.com","Envio Cr. FUENTES - FONDOS DE TESORO -","Cumplase Autorizado");  
//echo "paso";exit; 		
...
$pdf->SetX(150);
$pdf->Cell(0,4,'CUMPLASE DE RECURSOS DEL TESORO','0',0,'L',0);
