...
//conexion
		   ...
		   if (($importe < $total) or ($importe == $total))
			   {
				   ...
				   $sql = "UPDATE op_pendiente_tmp SET autorizado='$importe'  WHERE id = '$l'";
 ...
 content='0;url=../indextesoreria.php?sec=hacienda/modificar_orden_pendientes_2009&apli=hcop&per=A&consul=<?php echo $fecha_cons; ?> '/>	 </meta>              
