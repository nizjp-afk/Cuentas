   ...
   if($nom !='N')
    {
		 ...
		 $sql="SELECT  o.fecha as FECHA, s.ESCRITURAL AS ESCRITURAL,o.ejercicio AS EJERCICIO,o.orden_pago AS ORDEN ,b.cuitl AS CUIT,CONCAT (b.apellido,' ',b.nombre,' ',b.razon_social) AS DENOMINACION, o.concepto AS CONCEPTO,o.total AS TOTAL
...
echo "<table border='1'>";
echo "<tr>";
echo "<td align='center' colspan='8' bgcolor='#CCCCCC'>ORDENES PAGADAS FONDOS PROPIOS</td>";
echo "</tr>";
echo "<BR>";
