...
<br />
<br />
<h2>Cumplase a Confirmar - Recursos del Tesoro -</h2>

<br />
<br />
<br />
<form action="hacienda/imprimir_cumplase.php?apli=hcop&per=A" method="post"  target="_blank">
<?php
...
?>		 
    ...
    <tr>
       ...
       <td height="43"  align="center" ><a target="_blank"  href="hacienda/imprimir_a_confirmar.php?apli=h&tei=<?php echo $nro; ?>&per=A"><img src="img/pdf_cumplase.png"  border="0" /></a></td>
    </tr>
<?php
	 }
?>	 
