...
$pdf->setY(30);
$pdf->cell(0,0,'ANALISIS DETALLADO '.strtoupper($meses{$nombre_mes-1}).', '.$ejercicio,0,'B','C',0);
...
$pdf->Cell(30,7,'ACUMULADO',1,0,'C',1);
$pdf->Cell(30,7,'EXCEPCIONES',1,0,'C',1);

$pdf->Cell(30,7,'FUNCIONAMIENTO',1,0,'C',1);
$pdf->SetY($y_axis_initial+5);
$pdf->SetX(195);
$pdf->Cell(30,1,'(GASTO CORRIENTE)',0,0,'C',0);
...
$pdf->Cell(20,7,'VARIACION',1,0,'C',1);
 ...
 $pdf->SetY($i=$i+50);$ir=$i;
	...
	$saf_o = "SELECT obs_o
				 ...
				 if (!($f_saf_ao= mysqli_query($conexion_mysql,$saf_o)))
					{
					  //.....................................................................
					  // informa del error producido
					  $cuerpo1  = "al intentar buscar area";
				...
				$o=1;  
	$a_obser='';
				While($f_safao=mysqli_fetch_array($f_saf_ao)) 
				{
                  $obser=$f_safao['obs_o'];
	...
	$total_n=$total_n+$tota_an_saf;
	
	$str1 = strlen($a_obser);
				if($str1>89)
				{
					$cant_re = $str1 / 89; // cantidad de renglon
...
$pdf->Cell(20,7,'VARIACION',1,0,'C',1);
 ...
 $pdf->SetY($i=$i+50);
	...
	$pdf->Cell(30,$r,number_format($tota_ac_saf,2, ',', '.'),1,0,'R',1);
	$pdf->Cell(30,$r,number_format($tota_ae_saf,2, ',', '.'),1,0,'R',1);
	$pdf->Cell(30,$r,number_format($tota_an_saf,2, ',', '.'),1,0,'R',1);
...
//$pdf->MultiCell(100,6,$strText, 1, 'J', 1, 2, '', '', true, null, true);
		...
		$pdf->MultiCell(100,6,$a_obser, 1, 'J', 1, 2, '' ,'', true);
...
$pdf->Cell(35,7,'EXCEPCIONES',1,0,'C',1);
$pdf->Cell(40,7,'FUNCIONAMIENTO',1,0,'C',1);
$pdf->SetY($y_axis_initial+5);
$pdf->SetX(220);
$pdf->Cell(40,1,'(GASTO CORRIENTE)',0,0,'C',0);
...
$pdf->Cell(35,3,number_format($total_a,2, ',', '.'),0,0,'R',1);
	$pdf->SetX(185);
$pdf->Cell(35,3,number_format($total_e,2, ',', '.'),0,0,'R',1);
	$pdf->SetX(220);
$pdf->Cell(35,3,number_format($total_n,2, ',', '.'),0,0,'R',1);
...
$pdf->Cell(90,7,'TOTAL GENERAL',1,0,'C',1);
$pdf->Cell(35,7,'LIMITE',1,0,'C',1);

$pdf->Cell(35,7,'ACUMULADO',1,0,'C',1);
$pdf->Cell(35,7,'EXEPCIONES',1,0,'C',1);
$pdf->Cell(40,7,'FUNCIONAMIENTO',1,0,'C',1);
$pdf->SetY($i=$i+5);
$pdf->SetX(210);
$pdf->Cell(40,1,'(GASTO CORRIENTE)',0,0,'C',0);
