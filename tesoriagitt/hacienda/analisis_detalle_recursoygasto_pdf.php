...
$pdf->setY(30);
$pdf->cell(0,0,'ANALISIS RECURSOS - GASTO '.strtoupper($meses{$nombre_mes-1}).', '.$ejercicio,0,'B','C',0);
...
$pdf->Cell(15,7,'FFIN',1,0,'C',1);
$pdf->Cell(35,7,'RECURSO',1,0,'C',1);
$pdf->Cell(35,7,'GASTO',1,0,'C',1);
$pdf->Cell(35,7,'DIFERENCIA',1,0,'C',1);
...
$pdf->SetFont('Arial','IB',9);
$pdf->setY(30);
$pdf->cell(0,0,'ANALISIS RECURSO - GASTO'.strtoupper($meses{$nombre_mes-1}).', '.$ejercicio,0,'B','C',0);
$pdf->SetFont('Arial','IB',7);
$pdf->setY(35);
$pdf->SetX(140);
$pdf->cell(0,0,'ULTIMA ACTUALIZACION  '.$fecha_ua,0,'B','C',0);
...
AND i.banco = c.banco
	...
	$pdf->SetFont('arial','B',6);
	$pdf->Cell(15,6,$ffin_p,1,0,'L',1);
	$pdf->SetFont('courier','B',8);
    $pdf->Cell(35,6,number_format($total_ar_saf,2, ',', '.'),1,0,'R',1);
	$pdf->Cell(35,6,number_format($total_ap_saf,2, ',', '.'),1,0,'R',1);
	
	
	if($diferencia < 0)
	{
		$pdf->SetFillColor(253, 93, 96);
	$pdf->Cell(35,6,number_format($diferencia,2, ',', '.'),1,0,'R',1);
	}
	else
	{
$pdf->SetFillColor(256,256,256);
...
$pdf->Cell(35,7,'TOTAL GENERAL',1,0,'C',1);
$pdf->Cell(35,7,'RECURSO',1,0,'C',1);
$pdf->Cell(35,7,'GASTO',1,0,'C',1);
$pdf->Cell(35,7,'DIFERENCIA',1,0,'C',1);
$pdf->SetFillColor(256,256,256);
...
$pdf->SetX(45);
$pdf->Cell(35,3,number_format($total_ar,2, ',', '.'),0,0,'R',1);
$pdf->SetX(80);
$pdf->Cell(35,3,number_format($total_ap,2, ',', '.'),0,0,'R',1);
	$pdf->SetX(115);
...
$pdf->SetY($y_axis+15);
$pdf->SetX(30);
$tot_d=$total_ar-$total_ap;
$pdf->SetX(47);
$pdf->Cell(35,3,number_format($total_ar,2, ',', '.'),0,0,'R',1);
$pdf->SetX(85);
$pdf->Cell(35,3,number_format($total_ap,2, ',', '.'),0,0,'R',1);
	$pdf->SetX(125);
$pdf->Cell(35,3,number_format($tot_d,2, ',', '.'),0,0,'R',1);
$pdf->SetX(15);
$pdf->SetY($y_axis+20);
$pdf->Cell(190,5,'','T',0,'L',1);
