...
if ((isset($_POST['busca']) and !empty($_POST['busnom'])) or ( $_POST['busnom']!=''))
			{
				...
				AND (Ejercicio >='$fecha_cons' and Ejercicio <= '$fecha_ant')";
					 if (!($r_op= mysql_query($ssql, $conexion_mysql)))
					{
					  //.....................................................................
					  // informa del error producido
	...
	elseif (($_GET['busnom']!='' or $_GET['nom']!='') and (!(isset($_POST['busca']))) )
	  ...
	  else
	   {
		  ...
		  $ssql = "SELECT sum(`Saldos`) as saldo,sum(`Imp_orden`) as importe,sum(`Total_Pagado`) as total,count( `Numero_OP` ) as cant 
		  FROM op_pendientes where (Ejercicio >='$fecha_cons' and Ejercicio <= '$anterior') ";
				 if (!($r_op= mysql_query($ssql, $conexion_mysql)))
				{
				  //.....................................................................
				  // informa del error producido
...
WHEN 'I'
THEN 'I'
END AS estado, op_pendientes . * FROM op_pendientes where (Saf='$nom' or Numero_OP='$nom') AND (Ejercicio >='$fecha_cons' and Ejercicio <= '$fecha_ant') ORDER BY `estado` DESC,FECHA_OP desc,Numero_OP";
...
END AS estado, op_pendientes . * FROM op_pendientes where (Ejercicio >='$fecha_cons' and Ejercicio <= '$fecha_ant') ORDER BY `estado` DESC,FECHA_OP desc,Numero_OP"; 
	       }
	   }
  }
 else
...
WHEN 'I'
THEN 'I'
END AS estado, op_pendientes . * FROM op_pendientes where (Ejercicio >='$fecha_cons' and  Ejercicio  <= '$anterior') ORDER BY `estado` DESC,FECHA_OP desc,Numero_OP "; 
  }
...
$_pagi_propagar=array('sec','nom','apli','per','consul','fecha_ant');
...
<h2>Ordenes Pendientes de Pago Recursos del Tesoro Ejercios Vencidos</h2>
<br />
