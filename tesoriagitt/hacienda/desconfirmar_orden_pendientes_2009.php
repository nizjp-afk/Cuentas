	...
	if (isset($_POST['busca']) and !empty($_POST['busnom']))
			{
				...
				FROM op_pendiente_tmp where Ejercicio='$fecha_cons' and Saf='$nom' and nro_ti='$nro' ";
...
?>
<div class="content">
<h2>Desconfirmar Ordenes Autorizadas  <?php echo $fecha_cons; ?></h2>
...
<iframe src="hacienda/desconfirmar_2009.php?apli=hcop&per=A&saf=<?php echo $nom; ?>&consul=<?php echo $fecha_cons; ?>" width="100%" height="400px"
...
<ul>
    ...
    <li><a href="indextesoreria.php?sec=hacienda/modificar_orden_pendientes_2009&consul=<?php echo $fecha_cons; ?>&apli=h&per=A">Modificar Ordenes Autorizadas</a></li>
