...
<div class="content">
<form action="indextesoreria.php?sec=retenciones/guardar_afip_fp&apli=tgpc&per=A" method="post" name="sampleform">	
...
<table border="0" cellpadding="0" align="center">
  ...
  <tr>
        ...
        <td><input type="text" name="imponibless" readonly/></td> 
  </tr>
...
<table border="0" cellpadding="0" align="center"> 
   ...
   <tr>
        ...
        <td><input type="text" name="imponibleib" readonly/></td> 
  </tr>  
  <tr>
        <td  > Alicuota : 
        </td>
