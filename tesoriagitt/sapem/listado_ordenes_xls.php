...
$nuevafecha = date ( 'Y-m-d' , $nuevafecha );
	 ...
	 if($ej_a=='EA')
   { 
       $_pagi_sql = "SELECT `Fecha_OP` AS FECHA, op_pendientes.`Saf` AS SAF, `Ejercicio` , `Numero_OP` AS ORDEN,fuente as FF, b.cuitl AS CUIT, CONCAT( b.apellido, ' ', b.nombre, ' ', b.razon_social ) AS DENOMINACION, concepto AS CONCEPTO, `Imp_orden` , `Total_Pagado` , `Saldos`,op_pendientes.estado as ESTADO
...
echo "<tr>";
echo "<td align='center' colspan='".$columnas."' bgcolor='#CCCCCC'>ORDENES PENDIENTES DE PAGO</td>";
echo "</tr>";
echo "<BR>";
echo "<tr>";
...
if($ej_a=='EA')
   {   
        $_pagi_sql1 = "SELECT  fecha AS FECHA, o.saf AS SAF,ejercicio AS EJERCICIO, orden_pago AS ORDEN,o.fuente as FF, b.cuitl AS CUIT,  CONCAT( b.apellido, ' ', b.nombre, ' ', b.razon_social ) AS DENOMINACION, concepto AS CONCEPTO, total AS TOTAL 
