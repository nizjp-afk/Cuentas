...
{
?>
   <FORM name="sampleform" action="sapem/listado_ordenes_pagadas.php?apli=orden&per=T" method="POST" target="_blank" >
<?php
}
...
{
?>
   <FORM name="sampleform" action="sapem/listado_ordenes_pagadas_pdf.php?apli=orden&per=T" method="POST" target="_blank" >
<?php
}
...
{
?>
   <FORM name="sampleform" action="sapem/informe_detallado_periodo.php?apli=orden&per=T" method="POST" target="_blank" >
<?php
}
?>
<input type="hidden" name="tipo" value="<?php echo $sub_nrosaf;?>"  >
