...
<tr>
       ...
       <input name="ejer" type="submit" class="Boton" id="ejer" title="Ordenadas por Ejercicios de generacion de O.P" value="Ejercicio Anteriores" />
        ...
        <a title="Imprimir Consulta" href="sapem/listado_ordenes.php?consul=<?php echo $y ?>&tipo=<?php echo $sub_nrosaf;?>&nom=<?php echo $nom; ?>&ban=<?php echo $b_eje; ?>" target="_blank"  ><img src="img/pdf.png" width="35" align="" height="24" border="0"/></a>
      <?php if ($sub_nrosaf=='N'){ ?>  <a title="Imprimir Consulta" href="sapem/listado_ordenes_xls.php?consul=<?php echo $y ?>&nom=<?php echo $nom; ?>&ban=<?php echo $b_eje; ?>" target="_blank"  ><img src="img/xls.jpg"  width="35" align="" height="24" border="0"/></a> <?php 
	  }
	  } ?>  
		</td>   
...
THEN 'I' END AS estado, op_pendientes. *  FROM op_pendientes,beneficiarios_aprobados
				              where (cuit ='$nom' or concepto like '%$nom%' )
							   ...
							   and beneficiarios_aprobados.sociedad_tipo='30'
							   and (`Fecha_OP` !='2015-03-30' and `Fecha_OP` !='2015-03-31')
...
THEN 'I' END AS estado, op_pendientes. *  FROM op_pendientes,beneficiarios_aprobados
				              where (cuit ='$nom' or concepto like '%$nom%' )
							   ...
							   and beneficiarios_aprobados.sociedad_tipo='30'
							   and (`Fecha_OP` !='2015-03-30' and `Fecha_OP` !='2015-03-31')
							   and cuit in('33711935679','33679911509','30711807272') 			
							   order by Ejercicio,estado asc  ";
...
<ul>
      ...
      <li><a href="indextesoreria.php?sec=sapem/index1&apli=orden&per=P">Regresar Menu</a></li>
