...
//error_reporting ( E_ERROR );
  ...
  echo  $cuantos = count($archivo);
    for ($var=0;$var<$cuantos;$var++)
	{
		...
		echo $total_v1= trim($linea[16]);echo "<br>";
		echo $total_v=number_format($total_v1,2, '.', '');
		
		echo $total_f1= trim($linea[15]);echo "<br>";
		echo $total_f=number_format($total_f1,2, '.', '');
		
		echo $total_a_pagar_1= trim($linea[17]);echo "<br>";
		echo $total_a_pagar=number_format($total_a_pagar_1,2, '.', '');
