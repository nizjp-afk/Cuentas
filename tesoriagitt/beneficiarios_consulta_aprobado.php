...
<table width="90%"  border="1" align="CENTER" cellpadding="3" cellspacing="1" bgcolor="#DBE3E6" bordercolor="#EAEAEA" >
	...
	<?php if($tip=='j')
	       {
  	?>	   
    	<td height="30" colspan="6" align="center"><b>Consulta de Beneficiarios Aprobados Personas Juridicas</b></td>
	    <?php
	       }
		 if($tip=='f')
	       {
  	?>	   
    	<td height="30" colspan="6" align="center"><b>Consulta de Beneficiarios Aprobados Personas Fisicas</b></td>
	<?php
	       }  
		if($tip=='o')
	       {
  	?>	   
    	<td height="30" colspan="5" align="center"><b>Consulta de Beneficiarios Aprobados Otras Personas</b></td>
	<?php
	       }  
	     if ($tip=='')
		   {
