...
AND nro_ti = '$nro'
ORDER BY p.Saf,id_escritural, Numero_OP ASC ";
...
$pdf->cell(0,0,'HORA  :  '.$f_ope['hora'],0,'B','R',0);
...
$pdf->SetX(150);
$pdf->Cell(0,4,'CUMPLASE RECURSOS PROPIOS A CONFIRMAR
','0',0,'L',0);
  ...
  //If the current row is the last one, create new page and print column title
    ...
    if ($estado=='A')
	...
	else
	 {
		...
		$pdf->SetY($i=$i+7);
		$pdf->SetX(5);
        $pdf->Cell(18,6,$saf,1,0,'C',1);
		$pdf->SetFont('courier','',7);
		$pdf->Cell(20,6,$formul,1,0,'C',1);
		$pdf->Cell(10,6,$fuente,1,0,'C',1);
		$pdf->Cell(10,6,$clase,1,0,'C',1);
		$pdf->SetFont('courier','',5);
		$pdf->Cell(40,6,$beneficiario,1,0,'L',1);
...
$pdf->Cell(27,6,'Nuevo Saldo',1,0,'C',1);
		...
		$pdf->SetY($i=$i+9);
		$pdf->SetX(98);   
		$pdf->Cell(65,6,'TOTAL DEL SERVICIO :'.$aux,1,0,'L',1);
