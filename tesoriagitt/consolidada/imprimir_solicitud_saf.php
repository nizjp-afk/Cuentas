<?php
 error_reporting ( E_ERROR );
   ...
   // include('conexion/extras.php');
	...
	$ssql = "SELECT * FROM control_ti_saf  where c_fecha ='$d_fecha'  and  `nro_ti` >1  group by `numero` ";
...
while ($f_saf=mysql_fetch_array($r_saf))
 ...
 $ssql = "SELECT * FROM op_pendiente_tmp_saf  where Saf='$saf' 
          order by Saf,nro_ti,Numero_OP ASC ";
     if (!($r_op= mysql_query($ssql, $conexion_mysql)))
    {
	 ...
	 $ssql = "SELECT * FROM op_pendiente_tmp_saf where Saf='$saf' group by Ejercicio order by Ejercicio ";
...
$pdf->SetX(130);
$pdf->Cell(0,4,'SOLICITUD DE PAGOS '.$saf,'0',0,'L',0);
