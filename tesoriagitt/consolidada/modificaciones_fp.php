...
//conexion
   ...
   // include('conexion/extras.php');
	...
	$ssql = "SELECT * FROM `control_ti_saf`";
	...
	$nro =$f_cf['nro_ti'];
	 ...
	 $ssql = "SELECT * FROM op_pendiente_tmp_saf where Saf='$saf' and nro_ti='$nro' ";
...
<form action="modificar_importe.php?apli=s&per=A&consul=<?php echo $fecha_cons; ?>" method="post" target="_parent">
