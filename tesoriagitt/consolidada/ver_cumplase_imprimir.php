...
//conexion
   ...
   // include('conexion/extras.php');
	...
	$ssql = "SELECT * FROM op_pendiente_tmp_saf where nro_ti='$nro' and Saf='$nrosaf'
...
<br />
<br />
<h2>Solicitud de Pago <?php echo $nro;?></h2>
<br />
<br />
<br />
<br />
<form action="consolidada/imprimir_cumplase_confirmado.php?apli=s&per=A&saf=<?php echo $nrosaf;?>&cumpla=<?php echo $nro;?>" method="post"  target="_blank">
<?php
...
<ul>
    ...
    <li><?php if ($permisosnecesarios=='A')
	               {
		?>			   
	<a href="indextesoreria.php?sec=saf/index1&apli=s&per=A">Regresar Menu</a>
