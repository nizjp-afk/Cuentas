 ...
 error_reporting ( E_ERROR );
   ...
   // include('conexion/extras.php');
	...
	
	{
		...
		$ssql = "delete from `op_pendiente_tmp_fp` where `nro_ti` != '$nroaux'";
     if (!($r_cf= mysql_query($ssql, $conexion_mysql)))
    {
      //.....................................................................
      // informa del error producido
      ...
      //.....................................................................
		...
		$ssql = "UPDATE `op_pendiente_tmp_fp` SET  nro_ti='1' where `nro_ti` = '$nroaux'";
     if (!($r_cf= mysql_query($ssql, $conexion_mysql)))
    {
      //.....................................................................
      // informa del error producido
	...
	$nro=2;
	 ...
	 $ssql = "UPDATE control_fecha_fp SET c_fecha='$d_fecha' where id=1";
							 if (!($r_cf= mysql_query($ssql, $conexion_mysql)))
							{
							  //.....................................................................
							  // informa del error producido
	 ...
	 $ssql = "SELECT * FROM op_pendiente_tmp_fp where nro_ti='$nroaux' order by Saf,Numero_OP ASC ";
     if (!($r_op= mysql_query($ssql, $conexion_mysql)))
    {
	 ...
	 $ssql = "SELECT * FROM op_pendiente_tmp_fp where `nro_ti` = '$nroaux' group by Ejercicio order by Ejercicio ";
   ...
   $cant = mysql_num_rows($r_op);
	if ($cant>0)
	   {//llave 1
	$ssql = "UPDATE `op_pendiente_tmp_fp` SET  hora='$hora', tgp='C' where `nro_ti` = '$nroaux'";
     if (!($r_cf= mysql_query($ssql, $conexion_mysql)))
    {
      //.....................................................................
      // informa del error producido
	...
	$ssql = "UPDATE `control_fecha_fp` SET nro_ti='$nro'";
     if (!($r_cf= mysql_query($ssql, $conexion_mysql)))
    {
      //.....................................................................
      // informa del error producido
...
mail("aurora.lobos@gmail.com,tgp.larioja@gmail.com,eduescudero@larioja.gov.ar,manuelfuentesoro@gmail.com","Envio Cr. FUENTES -FONDOS PROPIOS-","Cumplase Autorizado");  
//echo "paso";exit; 		
...
$pdf->SetX(150);
$pdf->Cell(0,4,'CUMPLASE RECURSOS PROPIOS','0',0,'L',0);
  ...
  //If the current row is the last one, create new page and print column title
   ...
   if ($estado=='A')
	...
	else
	 {
		...
		$pdf->Cell(40,6,$concepto,1,0,'L',1);
		$pdf->SetFont('courier','',9);
...
if ($max==$cp )
    {
		...
		$pdf->Cell(10,6,'Clase',1,0,'C',1);
		$pdf->Cell(45,6,'Beneficiario',1,0,'C',1);
		$pdf->Cell(45,6,'Concepto',1,0,'C',1);
