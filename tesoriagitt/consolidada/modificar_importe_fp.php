...
//conexion
		   ...
		   if (($importe < $total) or ($importe == $total))
			   {
				   ...
				   $sql = "UPDATE op_pendiente_tmp_fp SET autorizado='$importe' 
				    WHERE id = '$l'";
 ...
 content='0;url=../indextesoreria.php?sec=consolidada/modificar_orden_consolidada_fp&consul=<?php echo $fecha_cons; ?>&apli=s&per=A&saf=<?php echo $saf; ?> '/>	 </meta>              
