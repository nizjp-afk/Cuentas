...
/*	include('dgti-mysql-var_dgti-beneficiarios.php');
   ...
   ////////////////////////////
		 ...
		 $_pagi_sql = "SELECT o.fecha,o.saf,o.orden_pago,o.concepto,o.total,o.ejercicio,b.nombre,b.apellido,b.razon_social
...
$pdf->setY(40);
$pdf->cell(0,0,'LISTADO DE ORDENES DE PAGO DE FONDOS PROPIOS',0,'B','C',0);
