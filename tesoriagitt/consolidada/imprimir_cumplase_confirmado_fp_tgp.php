 ...
 error_reporting ( E_ERROR );
   ...
   // include('conexion/extras.php');
	...
	//$fecha_cons=$_GET['consul'];	
	 ...
	 $ssql = "SELECT * FROM op_pendiente_tmp_fp  where nro_ti='$nro'  
...
echo 'paso';
//mail("mamacchi@larioja.gov.ar,aurora.lobos@gmail.com","Recibido TGP","Visto el cumplase ");   
	}
...
$pdf->SetX(80);
$pdf->Cell(0,4,'CUMPLASE DE FONDOS PROPIOS','0',0,'L',0);
