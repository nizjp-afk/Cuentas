...
$ssql = "SELECT MAX( `id` ) AS cant
         FROM op_pendiente_tmp_saf where  nro_ti='$nro' and Saf='$nrosaf' ";
...
?>
<div class="content">
<h2>Modificar Ordenes Solicitadas  <?php echo $fecha_cons; ?></h2>
...
<form action="consolidada/modificar_importe.php?apli=s&per=A&consul=<?php echo $fecha_cons; ?>" method="post" >
...
<ul>
    ...
    <li><a href="indextesoreria.php?sec=consolidada/desconfirmar_orden_consolidada&consul=<?php echo $fecha_cons; ?>&apli=s&per=A">Desconfirmar Ordenes Autorizadas</a></li>
    <li><a href="indextesoreria.php?sec=consolidada/cargar_orden_consolidada&consul=<?php echo $fecha_cons; ?>&apli=s&per=A">Confirmar Ordenes Pendientes</a></li>
     ...
     <li><a href="indextesoreria.php?sec=saf/index1&apli=s&per=A">Regresar Menu</a></li>
