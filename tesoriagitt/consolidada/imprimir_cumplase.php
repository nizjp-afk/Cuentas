 ...
 error_reporting ( E_ERROR );
   ...
   // include('conexion/extras.php');
	...
	$nro=$nro+1;
	 ...
	 $ssql = "SELECT * FROM op_pendiente_tmp_saf where nro_ti='$nroaux' and Saf='$nrosaf' order by Saf,Numero_OP ASC ";
     if (!($r_op= mysql_query($ssql, $conexion_mysql)))
    {
	 ...
	 $ssql = "SELECT * FROM op_pendiente_tmp_saf where `nro_ti` = '$nroaux' and Saf='$nrosaf' group by Ejercicio order by Ejercicio ";
   ...
   $cant = mysql_num_rows($r_op);
	if ($cant>0)
	   {//llave 1
		...
		$ssql = "UPDATE `control_ti_saf` SET nro_ti='$nro' where numero='$nrosaf'";
		 if (!($r_cf= mysql_query($ssql, $conexion_mysql)))
		{
		  //.....................................................................
		  // informa del error producido
		...
		$ssql = "UPDATE op_pendiente_tmp_saf set observacion='$observacion' where `nro_ti` = '$nroaux' and Saf='$nrosaf' ";
		 if (!($r_cf= mysql_query($ssql, $conexion_mysql)))
		{
		  //.....................................................................
		  // informa del error producido
...
//mail("jrosales@larioja.gov.ar,rosales3974@hotmail.com,aurora.lobos@gmail.com,eduescudero@larioja.gov.ar,mamacchi@larioja.gov.ar","Cumplase","Confirmacion Cumplase Autorizado"); 
//echo "paso";exit; 		
...
$pdf->SetFont('Arial','B',8);
$pdf->cell(0,0,'Nº Solicitud: '.$nroaux,0,'B','R',0);
...
$pdf->SetX(80);
$pdf->Cell(0,4,'SOLICITUD DE PAGO SERVICIO DE ADMINISTRACION FINANCIERA '.$nrosaf,'0',0,'L',0);
...
$pdf->Cell(27,6,'Solicitado',1,0,'C',1);
...
if ($max==$cp )
    {
		...
		$pdf->Cell(23,6,'Solicitado',1,0,'C',1);
...
$pdf->SetY(-20);
$pdf->SetX(30);
$pdf->MultiCell(0,$InterLigne,$observacion,0,'L',1);///////////
