...
if($saf=='N')
   {		
	 $ssql = "SELECT *  FROM `saf_escritural` WHERE ESTADO='A' and origen ='$origen' ORDER BY ESCRITURAL ";
	 
	 
   }
 else
   {
	  $ssql = "SELECT *  FROM `saf_escritural` WHERE ESCRITURAL ='$saf' and ESTADO='A' ORDER BY ESCRITURAL ";  
   }
