...
$ssql = "SELECT * FROM `op_pendiente_tmp_fp` where nro_ti='$nro' and tesoreria=''" ;
...
if ($visto > 0)
    {
		...
		$ssql = "UPDATE `op_pendiente_tmp_fp` SET tesoreria='V' where  nro_ti='$nro'";
			 if (!($r_cf= mysql_query($ssql, $conexion_mysql)))
			{
			  //.....................................................................
			  // informa del error producido
...
mail("manuelfuentesoro@gmail.com,aurora.lobos@gmail.com","Recibido TGP","Visto el cumplase "); 
   ...
   // include('conexion/extras.php');
	...
	$ssql = "SELECT *
FROM op_pendiente_tmp_fp AS p, saf_escritural AS e
WHERE e.ID = id_escritural
AND nro_ti = '$nro'
ORDER BY p.Saf, Numero_OP ASC ";
...
<br />
<br />
<h2>Cumplase Autorizado  Recursos Propios <?php echo $nro;?></h2>
<br />
<br />
<br />
<br />
<form action="consolidada/imprimir_cumplase_confirmado_fp.php?apli=hcop&per=A&cumpla=<?php echo $nro;?>" method="post"  target="_blank">
<?php
...
<tr>
     <td width="3%" align="center">Escritural</td>
     <td  width="8%">Formulario</td>
	   ...
	   if($f_orden['Ejercicio']==$Ejercicio)
	      {
			...
			?>
					 <tr align="right" bgcolor="#CCCCCC">
						 ...
						 <td colspan="6" ><?php echo 'Total del Servicio :'.$saf1.' - '.$aux; ?>
						 </td>
...
?>	
 ...
 <?php 
   ...
   ?>             <td height="28" align="center"><?php echo $f_orden['ESCRITURAL'];?></td>
