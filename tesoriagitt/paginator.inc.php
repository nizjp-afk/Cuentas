 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
 	...
 	$_pagi_result2 = mysqli_query($conexion_mysql,$_pagi_sqlConta);
	// Si ocurri� error y mostrar errores est� activado
 	...
 	$_pagi_totalReg = mysqli_fetch_assoc($_pagi_result2,0,0);//total de registros
 }else{
	$_pagi_result3 = mysqli_query($conexion_mysql,$_pagi_sql);
	// Si ocurri� error y mostrar errores est� activado
 ...
 */
 ...
 $_pagi_result = mysqli_query($conexion_mysql,$_pagi_sqlLim);
 // Si ocurri� error y mostrar errores est� activado
