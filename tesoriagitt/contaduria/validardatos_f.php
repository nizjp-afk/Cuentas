...
?>	   
      <form action="indextesoreria.php?sec=tesoreria/modificar_f" method="post">
<?php
	   }
	 else
	   {
...
?>	   
      <form action="indextesoreria.php?sec=contaduria/modificar_f&apli=tgpa&per=G" method="post">
<?php
	   }
	 else
	   {
?>	     
<form action="indextesoreria.php?sec=contaduria/update_f&apli=tgpa&per=G" method="post">
<?php 
        }
...
<table border="0" align="center">
	<tr>
		<td colspan="2"><h1>Validacion datos </h1></td>
	</tr>
	<tr height=10px>
		<td colspan="2"><hr></td>
	</tr>
