...
<form action="indextesoreria.php?sec=contaduria/validardatos_j&apli=tgpa&per=G" method="post">
<table border="0" align="center">
...
<?php
       ...
       <tr>	
				...
				<tr>
				 ...
				 <td>&nbsp;  </td>
				  <td width="353" height="28" >Porcentaje:	 &nbsp;&nbsp;&nbsp;
				  <input type="text" name="por3_u" size="4"  value="<?php if( $por3_u >0) {echo $por3_u; }?>"/></td>
       ...
       <tr>	
				...
				<tr>
				 <td width="353" height="28" >Porcentaje:	 &nbsp;&nbsp;&nbsp;
				  <input type="text" name="por4_u" size="4"  value="<?php if( $por4_u >0) { echo $por4_u; }?>"/></td>
				 <td>&nbsp;  </td>
				  <td width="353" height="28" >Porcentaje:	 &nbsp;&nbsp;&nbsp;
				  <input type="text" name="por5_u" size="4"  value="<?php if( $por5_u >0) { echo $por5_u; }?>"/></td>
				 <td>&nbsp;  </td>
				  <td width="353" height="28" >Porcentaje:	 &nbsp;&nbsp;&nbsp;
				  <input type="text" name="por6_u" size="4"  value="<?php if( $por6_u >0) { echo $por6_u; } ?>"/></td>
		    ...
		    <td colspan="2"><table>
              ...
              <tr>
                ...
                <td width="354" >Apellido:
                  <input type="text" name="apellido2" size="20"  maxlength="50" value="<?php echo $apellido2; ?>"/>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td width="354" >D.N.I:  &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" name="dni2" size="8" maxlength="8"  value="<?php echo $dni2 ?>"/>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="28">Fec.Inicio
                  <select name="f_inicio_d1" id="select" class="style11">
                      <option  value="---" >D&iacute;a</option>
                      <?php
                    ...
                    <select name="f_inicio_m1" id="select2" class="style11">
                      <option  value="---">Mes</option>
                      <?php
                    ...
                    <select name="f_inicio_a1" id="select3"  class="style11" onchange="calcular_fecha()">
                      <option  value="---">A&ntilde;o</option>
                      <?php
                        $fechaactual=strtotime('now');
                        $anioactual=substr(date('d/m/Y',$fechaactual),6,4);
                ...
                <td>&nbsp;</td>
                <td>Fec.Inicio
                  <select name="f_inicio_d2" id="select" class="style11">
                      <option  value="---" >D&iacute;a</option>
                      <?php
                    ...
                    <select name="f_inicio_m2" id="select2" class="style11">
                      <option  value="---">Mes</option>
                      <?php
                                 $meses= array('Ene','Feb','Mar','Abr','May','Jun','Jul','Agos',
								 'Sept','Oct','Nov','Dic');
                    ...
                    <select name="f_inicio_a2" id="select3"  class="style11" onchange="calcular_fecha()">
                      <option  value="---">A&ntilde;o</option>
                      <?php
                        $fechaactual=strtotime('now');
                        $anioactual=substr(date('d/m/Y',$fechaactual),6,4);
              ...
              <tr>
                <td width="353" height="28" >Fecha Fin:
                  <select name="f_fin_d1" id="select" class="style11">
                      <option  value="---" >D&iacute;a</option>
                      <?php
                    ...
                    <select name="f_fin_m1" id="select2" class="style11">
                      <option  value="---">Mes</option>
                      <?php
                                 $meses= array('Ene','Feb','Mar','Abr','May','Jun','Jul','Agos',
								 'Sept','Oct','Nov','Dic');
                    ...
                    <select name="f_fin_a1" id="select3"  class="style11" onchange="calcular_fecha()">
                      <option  value="---">A&ntilde;o</option>
                      <?php
                        $fechaactual=strtotime('now');
                        $anioactual='2040';
                ...
                <td width="354" >Fecha Fin:
                  <select name="f_fin_d2" id="select" class="style11">
                      <option  value="---" >D&iacute;a</option>
                      <?php
                    ...
                    <select name="f_fin_m2" id="select2" class="style11">
                      <option  value="---">Mes</option>
                      <?php
                                 $meses= array('Ene','Feb','Mar','Abr','May','Jun','Jul','Agos',
								 'Sept','Oct','Nov','Dic');
                    ...
                    <select name="f_fin_a2" id="select3"  class="style11" onchange="calcular_fecha()">
                      <option  value="---">A&ntilde;o</option>
                      <?php
                        $fechaactual=strtotime('now');
                       $anioactual='2040';
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td width="354" >Apellido:
                  <input type="text" name="apellido4" size="20"  maxlength="50" value="<?php echo $apellido4; ?>"/>
                </td>
              </tr>
              <tr>
                <td width="353" height="28">Nombre:
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td width="354" >D.N.I:  &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" name="dni4" size="8" maxlength="8"  value="<?php echo $dni4 ?>"/>
                </td>
              </tr>
              <tr>
                <td width="353" height="28">Cargo:	 &nbsp;&nbsp;&nbsp;
              ...
              <tr>
                <td height="28">Fec.Inicio
                  <select name="f_inicio_d3" id="select" class="style11">
                      <option  value="---" >D&iacute;a</option>
                      <?php
                    ...
                    <select name="f_inicio_m3" id="select2" class="style11">
                      <option  value="---">Mes</option>
                      <?php
                                $meses= array('Ene','Feb','Mar','Abr','May','Jun','Jul','Agos',
								 'Sept','Oct','Nov','Dic');
                    ...
                    <select name="f_inicio_a3" id="select3"  class="style11" onchange="calcular_fecha()">
                      <option  value="---">A&ntilde;o</option>
                      <?php
                        $fechaactual=strtotime('now');
                        $anioactual=substr(date('d/m/Y',$fechaactual),6,4);
                ...
                <td>&nbsp;</td>
                <td>Fec.Inicio
                  <select name="f_inicio_d4" id="select" class="style11">
                      <option  value="---" >D&iacute;a</option>
                      <?php
                    ...
                    <select name="f_inicio_m4" id="select2" class="style11">
                      <option  value="---">Mes</option>
                      <?php
                               $meses= array('Ene','Feb','Mar','Abr','May','Jun','Jul','Agos',
								 'Sept','Oct','Nov','Dic');
                    ...
                    <select name="f_inicio_a4" id="select3"  class="style11" onchange="calcular_fecha()">
                      <option  value="---">A&ntilde;o</option>
                      <?php
                        $fechaactual=strtotime('now');
                        $anioactual=substr(date('d/m/Y',$fechaactual),6,4);
              ...
              <tr>
                <td width="353" height="28" >Fecha Fin:
                  <select name="f_fin_d3" id="select" class="style11">
                      <option  value="---" >D&iacute;a</option>
                      <?php
                    ...
                    <select name="f_fin_m3" id="select2" class="style11">
                      <option  value="---">Mes</option>
                      <?php
                                 $meses= array('Ene','Feb','Mar','Abr','May','Jun','Jul','Agos',
								 'Sept','Oct','Nov','Dic');
                    ...
                    <select name="f_fin_a3" id="select3"  class="style11" onchange="calcular_fecha()">
                      <option  value="---">A&ntilde;o</option>
                      <?php
                        $fechaactual=strtotime('now');
                        $anioactual='2040';
                ...
                <td>&nbsp;</td>
                <td width="354" >Fecha Fin:
                  <select name="f_fin_d4" id="select" class="style11">
                      <option  value="---" >D&iacute;a</option>
                      <?php
                    ...
                    <select name="f_fin_m4" id="select2" class="style11">
                      <option  value="---">Mes</option>
                      <?php
                                 $meses= array('Ene','Feb','Mar','Abr','May','Jun','Jul','Agos',
								 'Sept','Oct','Nov','Dic');
                    ...
                    <select name="f_fin_a4" id="select3"  class="style11" onchange="calcular_fecha()">
                      <option  value="---">A&ntilde;o</option>
                      <?php
                        $fechaactual=strtotime('now');
                       $anioactual='2040';
 ...
 <tr>
		...
		<tr>
		  <td colspan="2" align="center">
			<a href="indextesoreria.php?sec=contaduria/beneficiarios_aprobado&apli=tgpa&per=G"><img src="img/cancelar.jpg" width="60" height="20" border="0"/></a>
