...
//if (strlen($num) > 14) die("El n?mero introducido es demasiado grande"); 
 ...
 $sql="SELECT * FROM nota_retencion WHERE orden='$orden' and saf='$saf' and fecha='$dia'";
 ...
 $ssql = "SELECT * FROM num_nota_ret" ;
	...
	$numero=$f_num['numero'];     
	 ...
	 $sql="INSERT INTO nota_retencion (orden,saf,numero,observacion,fecha)
        VALUES('$orden','$saf','$numero','$obs','$dia')";
...
Esta Nota ya fue ingresada..!!!  <b>  </p></center>
<code></code>
...
$texto1='															 	    		Habiendose detectado errores en el calculo de las retenciones, remito la
presente para su correccion.';
