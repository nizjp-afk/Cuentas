...
<table width="90%"  border="1" align="CENTER" cellpadding="3" cellspacing="1" bgcolor="#DBE3E6" bordercolor="#EAEAEA" >
	<tr>
	    ...
	    <td height="30" colspan="6" align="center"><b>Constancia de Retencion de Ganancias</b></td>
	<td height="30" colspan="2" ><a title="Listado de Orden de Pago" href="retenciones/imprimir_gral_gp.php?firstinput=<?php echo $fechahoy; ?>&secondinput=<?php echo $fechaant; ?>" target="_blank"  ><img src="img/print_odp.jpg" width="35" align="" height="24" border="0"/></a>   
		</td>     		   
	</tr>
	<tr>
