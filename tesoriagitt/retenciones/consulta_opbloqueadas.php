...
<table width="130%"  border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#DBE3E6" bordercolor="#EAEAEA" >
<tr>
...
if (isset($_POST['busca']) )
   	...
   	if  (!empty($_POST['busnom']) and !empty($_POST['ejercicio']) and empty($_POST['saf']))
				...
				FROM beneficiarios_aprobados, op_bloqueadas, tipo_op_bloqueadas
				WHERE ((`beneficiarios_aprobados`.`cuitl` =op_bloqueadas.cuit_beneficiario) AND (`op_bloqueadas`.`id_tipo_op_bloqueada` =tipo_op_bloqueadas.id)
				and op_bloqueadas.ejercicio='$ejercicio'  and op_bloqueadas.nro_esidif='$nom' and op_bloqueadas.estado='B')";
...
<table width="130%"  border="1" cellpadding="0" cellspacing="0"  >	   
 <tr class="fuframe1" >
     <td colspan="10" align="center"><font size="+1">Ordenes Bloqueadas</font></td>
  </tr>
  <tr class="fuframe1" >
 ...
 if ($f_orden['razon_social']=='')
		...
		//   $razon_social=$f_orden['razon_social'];
		 ...
		 $f_g=explode("-", $f_orden['fecha']); 
		  ...
		  ?>
	<tr bgcolor="#DBE3E6" class="fuframe">
     <td  align="center"><?php echo $fecha;?>;</td>
    <td  height="30" align="center"><?php echo $ejerciciob;?></td>
           <td  align="center"><?php echo $safb;?></td>
          ...
          <td  align="center"><a target="_parent" href="indextesoreria.php?sec=retenciones/modificar_bloqueo&apli=cr&per=R&id=<?php echo $f_orden['clave']; ?>"><img src="img/ok.png" border="0" height="16" width="16"/></a></td>
