...
//if (strlen($num) > 14) die("El n?mero introducido es demasiado grande"); 
 ...
 include('../dgti-mysql-var_dgti-beneficiarios.php');
    ...
    $id = $_GET['id'];
        ...
        $ssql = "SELECT b.apellido,b.nombre,b.nombre_f,razon_social,r.codigo, p.cuit,p.orden_pago, p.fecha AS fecha_pago,s.neto, d.importe AS retnecion,s.id,s.numero,s.id,CONCAT(b.direccion_f_calle ,' ',b.direccion_f_nro) as direccion,l.descripcion as localidades,v.nombre as provincia ,b.codigo_f_postal,r.observacion
						FROM orden_pago AS p, sicore AS s, anexorg830 AS r,beneficiarios_aprobados as b,localidades as l ,provincias as v,dd_retenciones as d
...
$ssql = "SELECT b.apellido,b.nombre,b.nombre_f,razon_social,r.codigo, p.cuit,p.orden_pago, p.fecha AS fecha_pago,s.neto, d.importe AS retnecion,s.id,s.numero,s.id,CONCAT(b.direccion_f_calle ,' ',b.direccion_f_nro) as direccion,l.descripcion as localidades,v.nombre as provincia ,b.codigo_f_postal,r.observacion
						FROM orden_pago_fp AS p, sicore AS s, anexorg830 AS r,beneficiarios_aprobados as b,localidades as l ,provincias as v,dd_retenciones as d
						WHERE p.orden_pago = s.orden
						AND b.cuitl=p.cuit
						AND p.ejercicio = s.ejercicio
						AND p.saf = s.saf
...
AND p.fecha = s.fecha_io";
         if (!($r_css_fp= mysql_query($ssql, $conexion_mysql)))
           {
			  ...
			  //.....................................................................
			  // informa del error producido
			  $cuerpo1  = "al intentar buscar beneficiario2";
			  echo $cuerpo1;
			  //.....................................................................
		    }  	
	 ...
	 $ssql = "SELECT b.apellido,b.nombre,b.nombre_f,razon_social,r.codigo, p.cuit,p.orden_pago, p.fecha AS fecha_pago,s.neto, s.monto AS retnecion,s.id,s.numero,s.id,CONCAT(b.direccion_f_calle ,' ',b.direccion_f_nro) as direccion,l.descripcion as localidades,v.nombre as provincia ,b.codigo_f_postal,r.observacion
						FROM orden_pago AS p, sicore AS s, anexorg830 AS r,beneficiarios_aprobados as b,localidades as l ,provincias as v
						WHERE p.orden_pago = s.orden
						AND b.cuitl=p.cuit
						AND p.ejercicio = s.ejercicio
						AND p.saf = s.saf
						...
						AND p.fecha = s.fecha_io";
         if (!($r_css_2015= mysql_query($ssql, $conexion_mysql)))
           {
	
			  //.....................................................................
			  // informa del error producido
			  $cuerpo1  = "al intentar buscar beneficiario3";
			  echo $cuerpo1;
			  //.....................................................................
		    }  	
...
AND p.ejercicio > '2014'
AND p.fecha = s.fecha_io";
         if (!($r_css_fp_2015= mysql_query($ssql, $conexion_mysql)))
           {
	
			  //.....................................................................
			  // informa del error producido
			  $cuerpo1  = "al intentar buscar beneficiario4";
			  echo $cuerpo1;
			  //.....................................................................
		    }  	
...
$can1_2015=mysql_num_rows($r_css_2015);
$can_2015=mysql_num_rows($r_css_fp_2015);
...
if ($can > 0)
 ...
 if ($can1_2015 > 0)
    {	
      $f_beneficiario= mysql_fetch_array ($r_css_2015); 
	  
	}
	
if ($can_2015 > 0)
    {	
      $f_beneficiario= mysql_fetch_array ($r_css_fp_2015); 
