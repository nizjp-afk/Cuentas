...
<div class="content">
<form action="indextesoreria.php?sec=retenciones/guardar_afip_fp&apli=cr&per=R" method="post" name="sampleform">	
...
<input type="hidden" name="orden1" value="<?php echo $orden1; ?>" >
   ...
   <TR>	  
      <td colspan="2" class="subtitle"><div align="center"><strong>
        <?php if ($f_situacion['razon_social']=='')
	               {
				    echo $f_situacion['apellido'].' '.$f_situacion['nombre']; 
...
?>
  ...
  <tr>
        ...
        <td><input type="text" name="retencion" readonly/></td> 
  </tr>
   <tr>
        <td  >Observacion : 
        </td>
...
?>
  ...
  <tr>
        ...
        <td><input type="text" name="retencionss" /></td> 
  </tr>
   <tr>
        <td  >Observacion : 
        </td>
...
<ul>
      ...
      <li><a href="indextesoreria.php?sec=retenciones/carga_orden_fp&apli=cr&per=R">Regresar Menu</a></li>
