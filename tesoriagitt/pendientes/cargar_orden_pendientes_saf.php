...
WHEN 'I'
THEN 'I'
END AS estado, op_pendientes . * FROM op_pendientes where Ejercicio='$fecha_cons'
...
WHEN 'I'
THEN 'I'
END AS estado, op_pendientes . * FROM op_pendientes where Ejercicio='$fecha_cons' and Saf='$nrosaf'
 ORDER BY FECHA_OP desc,Numero_OP DESC,`estado` DESC ";
			
		  
		  
		 
		  $ssql = "SELECT sum(`Saldos`) as saldo,sum(`Imp_orden`) as importe,sum(`Total_Pagado`) as total,count( `Numero_OP` ) as cant 
		  FROM op_pendientes where Ejercicio='$fecha_cons' and Saf='$nrosaf' and estado='N'";
				 if (!($r_op= mysql_query($ssql, $conexion_mysql)))
				{
				  //.....................................................................
				  // informa del error producido
...
<tr>
    	<td height="30" colspan="3" >Orden de Pago Nro.:<input  name="busnom" type="text" id="busnom" size="30" maxlength="50" />
         ...
         <td height="30" colspan="2" ><a title="Listado de Orden de Pago Pendientes" href="pendientes/listado_ordenes_pendientes.php?consul=<?php echo $fecha_cons; ?>&saf=<?php echo $nrosaf; ?>" target="_blank"  ><img src="img/print_odp.jpg" width="35" align="" height="24" border="0"/></a>   
		</td>  
...
?>	
            ...
            <td  height="30" align="center"><?php echo $f_ordenp['Ejercicio'];?></td>
         ...
         <td width="136" align="left"><?php echo substr($f_ordenp['Concepto'],0,25);?></font></td>
          ...
          <td width="77" align="right"><?php echo $f_ordenp['Saldos'];?></td>
           <td height="30"  align="center" title="<?php echo $obser; ?>"><strong>&nbsp;<?php if($resultado_resta > 365){echo $baja;} 
		                                                            else
																	{ 
		                                                          if($baja!='') { echo $baja; } 
