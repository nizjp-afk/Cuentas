...
<table  width="110%"  border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#DBE3E6" bordercolor="#EAEAEA" >
     <tr class="fuframe1">
      ...
      <td height="30" colspan="2" ><a title="Listado de Orden de Pago Pendientes" href="consolidada/listado_ordenes_pendientes_fp_bd.php?consul=<?php echo $fecha_cons; ?>&saf=<?php echo $nrosaf; ?>" target="_blank"  ><img src="img/print_odp.jpg" width="35" align="" height="24" border="0"/></a>   
		</td>   
