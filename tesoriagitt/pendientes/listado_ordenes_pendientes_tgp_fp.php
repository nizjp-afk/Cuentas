...
if ($nom=='')
    {	
		 ...
		 $_pagi_sql = "SELECT * FROM op_pendientes_fp_ch where Ejercicio='$fecha_cons'  order by Saf ";
    ...
    {
		$_pagi_sql = "SELECT * FROM op_pendientes_fp_ch where Ejercicio='$fecha_cons'
		           and (Saf='$nom' or cuit='$nom' or Numero_OP='$nom' or Beneficiario like '%$nom%') ";
...
$pdf->setY(45);
$pdf->cell(0,0,'LISTADO DE ORDENES DE PAGO PENDIENTES EJERCICIO '.$fecha_cons,0,'B','C',0);
