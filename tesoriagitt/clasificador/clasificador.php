                ...
                <p align="center"><font color="#CC0000" size="4" face="Verdana, Arial, Helvetica, sans-serif">Atenci&oacute;n</font></p>
                 <ul>
                         <div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" align="center"><strong> 
                          No Selecciono  CLASIFICADOR.</strong></font></div>
                 </ul>
                <p align="center">&nbsp;</p>
  ...
  while($fila= mysql_fetch_array($r_max))
   {
	...
	if(!(empty ($codigo) ))
      {
		  $cont_item=1;
		   $sql = "INSERT INTO clasificacion_orden (ejercicio,orden,saf,clasificador_id,fecha)
							 VALUE ('$ejercicio','$orden','$saf','$clasificador','$fecha')";
...
?>              		 
 ...
 content='0;url=indextesoreria.php?sec=clasificador/carga_orden_pagadas_dir&fechahoy=<?php echo $fechahoy;?>&fechaant=<?php echo $fechaant;?>&apli=tgpa&per=T'/>	 </meta>              
