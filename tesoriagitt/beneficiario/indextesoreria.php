...
<head>
	...
	<script type="text/javascript" src="js/iniciarmenu.js"></script>
...
<div class="container">	
    ...
    <?php if ($nombre !='')
	   {
		   ?>
	    <a href="indextesoreria.php">Principal</a>
	   ...
	   else
	   {
        ...
        <?php
		 ...
		 ?>  
		<a href="indextesoreria.php?sec=tesoreria/index1&apli=tgp&per=C">Tesoreria</a>
         
      <!-- <a href="indextesoreria.php?sec=hacienda/index1&apli=h&per=C">Hacienda</a>-->
       
       
	   
       	<a href="indextesoreria.php?sec=saf/index1&apli=s&per=E">SAF</a>
        <?php 
        if($nrosaf =='I'){ ?>
		<a href="indextesoreria.php?sec=retenciones_saf/beneficiarios_consulta_aprobado&apli=s&per=C">Retenciones</a>
        <?php
		}
		 if(!($nrosaf =='N') and !($nrosaf =='I')){ ?>
		<a href="indextesoreria.php?sec=retenciones_saf/index1&apli=s&per=C">Retenciones</a>
        <a href="indextesoreria.php?sec=tutoriales/index_saf&apli=s&per=C">Tutoriales</a>
        <?php
		}
		if($nrosaf =='N'){ ?>
		 <a href="indextesoreria.php?sec=ordenes/index_r1&apli=orden&per=C">Retenciones</a>
        <?php
		}
		
		if($nrosaf =='N'){ ?>
        <a href="indextesoreria.php?sec=ordenes/index1&apli=orden&per=C">Pagos /Pendientes</a>
        <?php 
	   }
	   ?>
    ...
    <a href="indextesoreria.php?sec=contaduria/index1&apli=cgp&per=T">Configuracion</a>
     <a href="index-logout2.php">Cerrar</a>
   
		<h3 align="right"><strong><font color="#F4F1F1"></font> &nbsp;&nbsp; <?php echo $nombre.', '; echo $razon;?></font></strong></h3>
...
?></td>
  ...
  <tr bgcolor="#768238">
	...
	<!-- Abrir Cuerpo|Pie -->
	<div class="footer">
	 2008 Sistema de Beneficiarios - Tesoreria General de la Provincia de la Rioja
	<!-- Cerrar Cuerpo|Pie -->
	</div>
<!-- Cerrar Cuerpo -->
</div>
