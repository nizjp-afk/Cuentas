...
error_reporting ( E_ERROR );
   ...
   $cuitl = $_GET['cuitl'];
	$id = $_GET['id'];
    $ssql = "SELECT * FROM `beneficiarios`,tipo_documento WHERE cuitl='$cuitl' or id_beneficiario='$id'";
...
$pdf->SetY($i=$i+7);
$pdf->SetX(25);
$pdf->Cell(15,5,'NOMBRE FANTASIA: ',0,0,'L',1);
$pdf->SetFont('Arial','B',8);
$pdf->SetY($i);
$pdf->SetX(55);
$pdf->Cell(20,5,$nombre_f,0,0,'L',1);
$pdf->SetFont('Arial','',7);
$pdf->SetY($i=$i+7);
$pdf->SetX(25);
