...
<tr>
        ...
        <input name="ejer" type="submit" class="Boton" id="ejer" title="Ordenadas por Ejercicios de generacion de O.P" value="Ejercicio Anteriores" />
         ...
         <a title="Imprimir Consulta" href="tribunal/listado_ordenes_fp_ed.php?consul=<?php echo $y ?>&nom=<?php echo $nom; ?>&ban=<?php echo $b_eje; ?>" target="_blank"  ><img src="img/pdf.png" width="35" align="" height="24" border="0"/></a>
        <a title="Imprimir Consulta" href="tribunal/listado_ordenes_fp_xls.php?consul=<?php echo $y ?>&nom=<?php echo $nom; ?>&ban=<?php echo $b_eje; ?>" target="_blank"  ><img src="img/xls.jpg"  width="35" align="" height="24" border="0"/></a>    
		<?php } ?></td>   
...
if (isset($_POST['busca']) and !empty($_POST['busnom']))
			{
			 ...
			 $_pagi_sql = "SELECT orden_pago.*, (IMP_FORM - RETENCION - IMPORTE_A_PAGAR+IMP_DESAF ) AS pagado, (IMP_FORM - RETENCION  )as Imp_orden,escritural.ESCRITURAL  FROM orden_pago,escritural
							  ...
							  and EJERCICIO='$y'
							   and orden_pago.cuit='30682472762'
