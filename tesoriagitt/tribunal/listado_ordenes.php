...
$nuevafecha = date ( 'Y-m-d' , $nuevafecha );
 ...
 if($ej_a=='EA')
   { 
	   ...
	   $importe_g=$f_ordenes_sp['Total_Pagado'];
	   $total_g=$f_ordenes_sp['Imp_orden'];
	   $saldo_g=$f_ordenes_sp['Saldos'];
...
$pdf->Cell(0,10,'Pagina '.$pdf->PageNo().'/{nb}',0,0,'C');
			...
			if($ej_a=='EA')
  {
   ...
   $pdf->cell(0,0,'ORDENES PENDIENTE DE PAGO EJERCICIO '.$y,0,'B','C',0);
			...
			$pdf->Cell(75,5,number_format($total_g,2),0,0,'R',1);
			$pdf->Cell(25,5,number_format($importe_g,2),0,0,'R',1);
			$pdf->Cell(25,5,number_format($saldo_g,2),0,0,'R',1);
...
$pdf->Cell(0,10,'Pagina '.$pdf->PageNo().'/{nb}',0,0,'C');
			...
			if($ej_a=='EA')
  {
   ...
   $pdf->cell(0,0,'ORDENES PAGADAS EJERCICIO '.$y,0,'B','C',0);
			...
			$pdf->Cell(100,5,number_format($pago_total,2),0,0,'R',1);
