...
{
?>
   <FORM name="sampleform" action="tribunal/listado_ordenes_pagadas.php?apli=orden&per=T" method="POST" target="_blank" >
<?php
}
...
{
?>
   <FORM name="sampleform" action="tribunal/listado_ordenes_pagadas_pdf.php?apli=orden&per=T" method="POST" target="_blank" >
<?php
}
?>
