...
$pdf->setY(10);
$pdf->SetX(165);
$pdf->cell(30,10,'FM TGP Nº01 ',1,'B','R',0);
// (ancho,alto,texto,borde 0(sin borde):1(con borde),L: izquierda T: superior R: derecha B: inferior,alineacion (L,C,R),
...
$pdf->setY(40);
$pdf->cell(0,0,'FORMULARIO DE SOLICITUD DE MODIFICACION DE CUENTADANTES ',0,'B','C',0);
$pdf->SetFont('Arial','B',10);
$pdf->setY(48);
$pdf->SetX(25);
...
modificacion, de los Cuentadantes o Responsables de la Cuenta que se detalla a continuacion
a fin de encuadrarnos dentro de la normativa vigente:';										
...
$pdf->SetFillColor(215,215,215);
$pdf->Cell(170,4,'BAJAS - DATOS DE LOS RESPONSABLES -',1,0,'C',1);
$pdf->SetFillColor(256,256,256);
$pdf->SetFont('Arial','B',8);
...
$pdf->SetFillColor(215,215,215);
$pdf->Cell(170,4,'ALTAS - DATOS DE LOS RESPONSABLES -',1,0,'C',1);
$pdf->SetFillColor(256,256,256);
$pdf->SetFont('Arial','B',8);
...
$pdf->SetY($i);
$pdf->SetX(120);
$pdf->Cell(75,6,'CUIT Nº :',1,0,'L',1);$pdf->SetY($i=$i+5);
$pdf->SetX(25);
$pdf->Cell(170,6,'FECHA Y LUGAR DE NACIMIENTO: ',1,0,'L',1);
$pdf->SetY($i=$i+5);
$pdf->SetX(25);
