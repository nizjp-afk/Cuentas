   ...
   function restaFechas($dFecIni, $dFecFin)
{
    ...
    if($ej_a=='EA')
   {
       ...
       $_pagi_sql = "SELECT *,orden_pago.ESTADO as est_o, (IMP_FORM - RETENCION - IMPORTE_A_PAGAR) AS pagado, (IMP_FORM - RETENCION )as Imp_orden,e.DENOMINACION  FROM orden_pago,escritural AS e
		...
		$_pagi_sql_p = "SELECT SUM(IMP_FORM - RETENCION - IMPORTE_A_PAGAR) AS pagado, SUM(IMP_FORM - RETENCION )as Imp_orden, SUM(IMPORTE_A_PAGAR) as imp_a_pagar  FROM orden_pago,escritural AS e
				              where ((NUMERO='$op_n' and FORMULARIO='$op_f' AND orden_pago.SAF='$op_s') or CUIT ='$nom' )
