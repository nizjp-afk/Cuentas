   ...
   if (isset($_POST['busca']) and !empty($_POST['busnom']))
			{  
		        ...
		        $fechahoy = $_POST['fechahoy']; 
		 		$nom = $_POST['busnom'];
		 		$_pagi_sql = "SELECT  *
			  				 FROM orden_pago_fp as o,nro_saf as s,beneficiarios_aprobados as b
...
$_pagi_propagar=array('sec','nom','fechahoy','fechaant','apli','per','saf','origen');
...
<tr>
        ...
        <td height="30" colspan="2" ><a title="Listado de Orden de Pago" href="saf/listado_ordenes_dir_fp.php?fechah=<?php echo $fechahoy; ?>&fehcaa=<?php echo $fechaant; ?>&nom=<?php echo $saf_c; ?>&cuit=<?php echo $nom; ?>" target="_blank"  ><img src="img/print_odp.jpg" width="35" align="" height="24" border="0"/></a>   
		</td>     
    </tr>
</table>    
