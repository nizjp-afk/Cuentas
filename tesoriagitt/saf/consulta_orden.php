...
<tr>
       ...
       <input name="ejer" type="submit" class="Boton" id="ejer" title="Ordenadas por Ejercicios de generacion de O.P" value="Ejercicio Anteriores" />
        ...
        <a title="Imprimir Consulta" href="pendientes/listado_ordenes_pendientes_ft.php?consul=<?php echo $y ?>&nom=<?php echo $nom; ?>&ban=<?php echo $b_eje; ?>&saf=<?php echo $nrosaf; ?>" target="_blank"  ><img src="img/print_odp.jpg" width="35" align="" height="24" border="0"/></a>   
		<?php } ?></td>   
...

{
 ...
 <br />
 <tr class="fuframe" >
     <td colspan="10" align="center"><font size="+1">Ordenes Pagadas</font></td>
  </tr>
...

{
 ...
 <br />
 <tr class="fuframe" >
     <td colspan="10" align="center"><font size="+1">Orden Pagada Total</font></td>
  </tr>
